...
Examples:
  ...
  codify spec my-api --from-context . --model claude-sonnet-4-6`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			projectName := args[0]
			return runSpec(projectName, fromContext, output, model, locale)
		},
	}

	cmd.Flags().StringVar(&fromContext, "from-context", "", "Path to existing context directory (required)")
	_ = cmd.MarkFlagRequired("from-context")
	cmd.Flags().StringVarP(&output, "output", "o", "", "Output directory (default: same as --from-context)")
